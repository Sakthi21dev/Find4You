...
<html lang="en">
	...
	<header>
		<nav>
			...
			<li class="nav-link active"><a href="../User/login.jsp">User</a></li>
	...
	<form autocomplete="off" method="post" action="signupAction.jsp">
		<fieldset class="details">
			...
			<div class="message">
				...
				{ %>
				<h3 class="warning red">Password mismatch</h3> 
				<% }
				else if("found".equals(msg))
				{%> 
				<h3 class="warning red">User Already Found</h3> 
				<%}else if("error".equals(msg))
				{%>
				
				<h3 class="warning red">Something went wrong. Please try later...</h3>
				<% } %>
				
			</div>
			<fieldset class="buttons" >
				
				<button class="green" type="submit" >Sign Up</button>
